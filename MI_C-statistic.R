...
par(mfrow=c(1,3))
# plot histogram
hist(results$C.statistic, freq = F, breaks = 30, main = 'Distribution of C-statistic')
# plot densityplot
...
# plot histogram
hist(logit.C, freq = F, breaks = 30, main = 'Distribution of logit transformed C-statistic')
# plot densityplot
...
# plot histogram
hist(arcsine.C, freq = F, breaks = 30, main = 'Distribution of arcsine transformed C-statistic')
# plot densityplot
